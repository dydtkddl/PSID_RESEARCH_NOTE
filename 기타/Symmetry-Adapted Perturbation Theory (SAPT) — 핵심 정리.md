...
> SAPT에서 **induction(유도/분극)** 과 **dispersion(분산)** 은 모두 “비공유 상호작용” 성분이지만, 원인이 다르다. **Induction** 은 한 분자(또는 이온)가 만드는 **정전기장** 때문에 다른 분자의 전자구름이 **평균적으로(정적 또는 준정적) 왜곡**되는 효과로, 쉽게 말해 “상대가 만들어 놓은 전기장에 의해 내 전하분포가 재배열되는 반응”이며, 이 과정에는 영구 쌍극자/전하에 의해 유도된 쌍극자 같은 성분이 포함된다. 반면 **dispersion** 은 두 분자에 영구 쌍극자가 없어도 나타나는 인력으로, 전자들이 순간적으로 흔들리며 생기는 **순간 쌍극자(instantaneous fluctuation)** 가 상대의 전자와 **상관(correlation)** 되어 동조된 흔들림을 만들면서 생기는 효과이다(런던 분산력). 요약하면 induction은 “상대의 **평균 전기장**에 대한 전자구름의 **응답(분극)**”이고, dispersion은 “전자 **요동의 상관**에서 나오는 **보편적 인력**”이며, SAPT에서는 둘 다 보통 2차 항에서 등장하지만(교환 보정 항이 동반됨) 물리적 기원과 의존성이 분명히 구분된다.
